...
//    public String[] currentTabKeyArray;
    ...
    private String[] tabNamesArr = {"Gem", "Enemy", "Msc."};
    ...
    // Each column represents the corresponding indexed subtab.
    // For the Msc. subtab, purple = boss drops, blue = mora, grey = local speciality.
    // Note that with my artificial cap of 10000, we can't track mora one-to-one (maybe track in the thousands?.
    private int[][] reqMats = {{6, 9, 9, 1, 0},
            {0, 0, 36, 30, 18},
            {0, 46, 420000, 0, 168}};
...
//        txtTemp2.setText("0:" + Arrays.toString(tabValArray0) + "\n" + "1:" + Arrays.toString(tabValArray1) + "\n" + "2:" + Arrays.toString(tabValArray2));
    ...
    public void updateViews() {
        ...
        txtTypeTitle.setText("Character");
